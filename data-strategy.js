...
const CARDS_STRATEGY = [
  ...
  },
  {
    ...
    description: 'National forecasting capability delivered as a shared enterprise service — providing channel-level (eComm vs. store) and placement-split forecast outputs consumed by Buying, Allocation, and Planning teams without each workstream running independent forecast models. Enables AEX to consume forecasts in a form that supports executable planning today while aligning with Assortment Planning\u2019s service-based forecasting architecture. Includes model explainability and automated training pipelines.',
