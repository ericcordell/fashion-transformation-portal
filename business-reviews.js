...
const BIG_ROCK_PROGRAM_MAP = {
  rock1: { // Trend Anticipation
    q1: ['neo-replatform', 'auto-item-setup'],  // Neo Replatform (Mar 2), Automated Item Setup (Apr 30)
    ...
    q3: ['strategy-hub', 'strategy-hub-data-inputs', 'forecast-enterprise-service', 'ap-tool-lineplan'],  // Strategy Hub (Oct 31), Data Inputs (Oct 31), Forecast Service (Oct 31), AP Tool (Aug 1)
  ...
  rock2: { // Proactive Allocation  
    ...
    q3: ['enterprise-wave-planning', 'fashion-fixture-allocation-buying', 'fashion-fixture-tagging', 'tag-based-recommendations', 'bq-enterprise-service'],  // Wave Planning (Aug 1), Fashion Fixture (Oct 31), Fixture Tagging (Oct 31), Tag Recommendations (Oct 31), BQ Enterprise (Oct 31)
    q4: ['oneitem-expanded-sources'],  // OneItem Expanded Sources (Jan 30, 2027)
  },
