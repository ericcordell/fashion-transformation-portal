...
const CARDS_DESIGN = [
  {
    ...
    critical: true,
    status: 'yellow', statusLabel: 'Yellow \u2014 Initial Requirements', jiraStatus: 'Initial Requirements',
    quarter: 'Q2', targetDate: 'Jun 30, 2026',
    tag: 'Critical Program',
    recentUpdate: 'Apr 2, 2026 \u2014 Requirements being gathered. The team is reviewing integration points and use cases. (OPIF-325208)',
