...
const BIG_ROCK_PROGRAM_MAP = {
  rock1: { // Trend Anticipation
    q1: ['strategy-hub', 'forecast-enterprise-service'],  // Strategy Hub, Forecast Enterprise Service
    q2: ['design-hub-centric', 'ap-tool-lineplan'],  // Design Hub (Centric PLM), AP Tool Line Plan
    q3: ['shared-merch-strategy', 'visual-boards'],  // Shared Merch Strategy, Visual Boards
    q4: ['ap-tool-shared-ideation', 'strategy-hub-data-inputs'],  // AP Tool Shared Ideation, Strategy Hub Data Inputs
  },
  rock2: { // Proactive Allocation  
    q1: ['aex-stability-q1', 'auto-item-setup'],  // AEX Stability Q1, Automated Item Setup
    q2: ['fashion-fixture-allocation-buying', 'ai-item-repository'],  // Fashion Fixture Allocation, AI Item Repository
    q3: ['enterprise-wave-planning', 'tagging-pilot'],  // Enterprise Wave Planning, Tagging Pilot
    q4: ['tag-based-recommendations', 'unified-planning'],  // Tag-based Recommendations, Unified Planning
  },
  rock3: { // Connected Systems
    q1: ['aex-stability-q1', 'shared-item-repository'],  // AEX Stability, Shared Item Repository
    q2: ['auto-item-setup', 'ai-item-repository', 'bq-enterprise-service'],  // Item Setup, AI Repo, BQ Enterprise
    q3: ['bam-collab-intent', 'size-pack-bq'],  // BAM/Collab Integration, Automated Size/Pack
    q4: ['global-buying-platform', 'oneitem-expanded-sources'],  // Global Buying Platform, OneItem Expanded Sources
  },
};
