...
const CARDS_STRATEGY = [
  {
    ...
    techIntegration: 'Primary OPIFs: OPIF-368304 (Strategy Hub: Create and centralize business strategy, Initial Requirements) and OPIF-374141 (Strategy Hub Internal and External Data Inputs, Backlog). Both owned by Charitha Katupitiya (TTP). Discovery underway — Apr 8 onward: DMM interviews, collecting strategy documents, connecting with data partners, formulating MLP scope, estimating engineering resources. OPIF-374141 newly filed Apr 16 to track data input requirements separately. Strategy Hub serves as the upstream data source for AEX, Centric, and BPE/DBP; decisions recorded here propagate downstream without manual re-entry.',
    ...
    recentUpdate: 'Apr 16, 2026 – OPIF-374141 (Strategy Hub Internal and External Data Inputs) newly filed and now tracked.  |  Apr 8, 2026 – Discovery underway: DMM interviews, collecting strategy documents, connecting with data partners to share needs, formulating MLP scope and experience, estimating engineering resources.',
    ...
    resources: res(
      ...
      [
        ...
        { label: 'OPIF-374141 — Strategy Hub Internal and External Data Inputs', url: 'https://jira.walmart.com/browse/OPIF-374141' },
