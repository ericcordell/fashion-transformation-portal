...
const CARDS_DESIGN = [
  {
    ...
    quarter: 'Q1', targetDate: 'Mar 20, 2026',
    tag: 'Critical Program',
    recentUpdate: 'Design Hub (Centric Integration) (OPIF-325208): Requirements being gathered. The team is reviewing integration points and use cases.  |  Milestone - Review of High Level Capabilities in Centric and Proposal for Which Are Owned There VS AP Tool and OneSource (OPIF-347498): Milestone Only. Christopher has stated that this is now complete.  |  Shared Merch Strategy (OPIF-325206): 3.0',
