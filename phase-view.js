...
(function () {
  ...
  function _cardHTML(card, pillar) {
    ...
    return [
      ...
      ' role="button" tabindex="0">',
        // Title row — tag removed so it never competes with the title for space
        '<div style="display:flex;align-items:flex-start;gap:6px;margin-bottom:6px;">',
          '<span style="font-size:1.05rem;flex-shrink:0;">' + card.icon + '</span>',
          '<span style="font-weight:600;font-size:0.81rem;line-height:1.35;color:#1e293b;min-width:0;">' + card.title + '</span>',
        '</div>',
        // Badges row — tag lives here, flex-wrap handles any width naturally
