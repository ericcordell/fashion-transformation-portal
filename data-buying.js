...
const CARDS_BUYING = [
  ...
  },
  {
    ...
    recentUpdate: 'AEX - Automated Item Set Up (OPIF-344926): 7-Apr-2026 - Development in progress. Based on discussion additional reporting scope has been added This will require changes in both IIR and Execution. 80-90% of the scope fully defined and meetings setup to finalize rest of the requirements. Meeting with Reesa to finalize the rest of the scope of…  |  Move Fashion Line Planning to AP Tool Assortment…',
  ...
  },
  {
    ...
    priority: 'P1',
    techRank: 1,
    recentUpdate: '7-Apr-2026 - Development in progress. Based on discussion additional reporting scope has been added This will require changes in both IIR and Execution. 80-90% of the scope fully defined and meetings setup to finalize rest of the requirements. Meeting with Reesa to finalize the rest of the scope of…',
  ...
  },
  {
    ...
    recentUpdate: 'Move Fashion Line Planning to AP Tool Assortment List (OPIF-325568): 7-Apr-2026 : Architecture meeting still in progress. Meeting has been setup on 8-Apr. (Owner Ryan/Satya) Approach Decision: Adopt an MVP approach to transition LP from NEO to APT, rather than pursuing a big‑bang migration. MVP Challenges: The MVP approach introduces integration challenges between…  |  AEX Fashion:  Use…',
