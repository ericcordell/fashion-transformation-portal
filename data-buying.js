...
const CARDS_BUYING = [
  ...
  },
  {
    ...
    recentUpdate: 'Move Fashion Line Planning to AP Tool Assortment List (OPIF-325568): 14-Apr-2026 :Architecture meeting is now complete and all different approaches reviewed. Next step to provide a high level sizing (Owner Ryan/Satya) Approach Decision: Adopt an MVP approach to transition LP from NEO to APT, rather than pursuing a big‑bang migration. MVP Challenges: The MVP approach…  |  AEX Fashion:  Use…',
