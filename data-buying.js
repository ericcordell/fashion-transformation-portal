...
const CARDS_BUYING = [
  ...
  },
  {
    ...
    recentUpdate: 'AEX - Automated Item Set Up (OPIF-344926): 14-Apr-2026 - Development in progress. Based on discussion additional reporting scope has been added This will require changes in both IIR and Execution. 80-90% of the scope fully defined and meetings setup to finalize rest of the requirements. Meeting with Reesa to finalize the rest of the scope…  |  Move Fashion Line Planning to AP Tool Assortment List…',
  ...
  },
  {
    ...
    priority: 'P1',
    techRank: 1,
    recentUpdate: '14-Apr-2026 - Development in progress. Based on discussion additional reporting scope has been added This will require changes in both IIR and Execution. 80-90% of the scope fully defined and meetings setup to finalize rest of the requirements. Meeting with Reesa to finalize the rest of the scope…',
  ...
  },
  {
    ...
    quarter: 'Q4', targetDate: 'Requirements gathering underway.',
  ...
  },
  {
    ...
    quarter: 'Q2', targetDate: 'Gathering requirements.',
    jiraStatus: 'Work in Progress',
    priority: 'P1',
    techRank: 2,
    tag: 'Critical Program',
    recentUpdate: 'AEX Fashion:  Use Assortment Planning\'s  Plan Creation & Plan List (OPIF-325216): 5.0  |  Fashion Metrics Enablement in Assortment List and Downstream Validation (OPIF-325217): 6.0  |  Fashion Re-Use of Assortment Planning Potential Item Excel Upload when in Assortment List (OPIF-325565): 12.0',
