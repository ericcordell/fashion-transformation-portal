...
const CARDS_BUYING = [
  ...
  },
  {
    ...
    description: '3 pillars all on track: (1) Gen AI Data Enrichment, (2) Parent Anchored Variant Groups, (3) Seamless Data Flow (AEX → Item). Removes merchant execution from item setup and PO creation once assortment decisions are finalized in AEX. Captures merchant intent upfront — eliminating re-entry loops and supplier clarification cycles. Exception management shifted to IDC team (human-in-the-loop model). Jira update (Mar 9, 2026): 09-Mar-2026 - Walkthroughs are underway and is said to be ready for sizing. Risk  : The project is currently in the discovery phase with a high priority, leadership-mandated deadline of April 30.   Path to Green : Product is conducting walkthroughs a Current status: Green — On Track. Assignee: Abhishek Jannawar. Leadership-mandated deadline: April 30, 2026.',
