...
const BIZ_IMPACT_GOALS = [
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    capabilities: [
      ...
      {
        label: 'Commitment report data flows automatically to markdown & replenishment — no export step',
      ...
      {
        label: 'OneItem indexes all item sources — ROM, 3P, and Circana auto-populate line plan',
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    capabilities: [
      ...
      {
        label: 'AP Tool becomes the single line plan entry point — no AEX tool exits required',
      ...
      {
        label: 'BQ runs as enterprise service — replaces team-by-team manual size calculations',
      ...
      {
        label: 'Global Buying Platform connects international assortment — market-specific tools retired',
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    capabilities: [
      ...
      {
        label: 'Style-level commitment report rebuilt — planners generate buy views in seconds',
      ...
      {
        label: 'Vendor collaboration through Supplier One — sample chasing via email eliminated',
      ...
      {
        label: 'BQ enterprise service delivers automated recommendations — manual team runs retired',
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    capabilities: [
      ...
      {
        label: 'Tag-based item recommendations surface AI assortment suggestions in-line',
      ...
      {
        label: 'In-season swap recommendations auto-generated on sell-through degradation',
      ...
      {
        label: 'AI markdown recommendations reduce manual clearance planning effort',
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    capabilities: [
      ...
      {
        label: 'OneItem shared repository connects all workstreams — single item from design to allocation',
      ...
      {
        label: 'OneItem extended to all sourcing markets — domestic and international unified',
