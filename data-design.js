...
const CARDS_DESIGN = [
  {
    ...
    description: 'Full launch of Centric PLM as the centralized Design Hub — replacing fragmented design tools with a single system of record for all Fashion product design and development. Requirements gathering underway. Includes milestone review of high-level Centric capabilities and ownership proposal for which workflows live in Centric vs. AP Tool vs. OneSource. Milestone OPIF-347498 (Centric capabilities review) is DONE. OPIF-347500 (full verticals review with proposal) is in Backlog. Owned by Christopher Chiodo (TPM).',
    ...
    owners: pptOwners('Chris Chiodo', 'Christopher Chiodo', ''),
    resources: res(
  ...
  },
  {
    ...
    tag: 'Critical Program',
    description: 'Migration of the AEX Fashion Line Planning experience to the AP Tool Assortment List — replacing the legacy line plan module with the Assortment Planning Plan Creation & Plan List. Includes enabling fashion-specific metrics, attributes, Excel upload reuse, and potential item population via Item Repository and OneItem workflow. Merchants get out of Excel permanently. Sizing pending for multiple sub-OPIFs. Assignee: Ashwin Chidambaram.',
    ...
    owners: pptOwners('Chris Chiodo', 'Ashwin Chidambaram', ''),
    resources: res(
  ...
  },
  {
    ...
    status: 'roadmap', statusLabel: 'Roadmap', quarter: 'Q2', targetDate: 'May\u2013Jul 2026',
    description: 'Integration of a shared event layer connecting AP Tool, Centric, and OneSource — enabling real-time data flow across Design, Buying, and Strategy systems without point-to-point coupling. Shared Project Tracking and Event Calendar (OPIF-325188) establishes the tracking and calendar scaffolding that supports this integration. Requirements gathering underway. Assignee: Christopher Chiodo.',
  ...
  },
  {
    ...
    description: 'Visual Boards in Centric — a collaborative visual workspace that deprecates Bamboo Rose and moves design teams off Miro, centralizing fit management and visual assortment planning directly in the Centric platform with live product data and no separate sync required. Requirements gathering underway. Assignee: Christopher Chiodo. Critical path item: Centric contract finalization (12-week onboarding lead time required).',
