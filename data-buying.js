...
const CARDS_BUYING = [
  ...
  },
  {
    ...
    description: 'Assisted Fixture Allocation capability enabling merchants to plan product placement across store fixtures with an AI-assisted visual interface — requirements gathering underway. Corresponds with Dhaarna Singh to determine Q1 scope. Builds on tagging and affinity graph data as a foundation. PRD in progress. Jira: OPIF-325598.',
  ...
  },
  {
    ...
    description: 'Buy Quantification and Flow delivered as a shared enterprise service — providing demand-driven buy quantity recommendations across all Fashion workstreams without each team running independent BQ calculations. Requirements gathering underway. Jira: OPIF-325218. Part of the Recommend & Optimize phase of the LLTT roadmap (Q3 FY27 – Q1 FY28). Includes rollup reporting, dynamic PO re-distribution, pack simplification, unified planner experience, and channel/placement-split forecasting.',
