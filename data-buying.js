...
const CARDS_BUYING = [
  ...
  },
  {
    ...
    quarter: 'Q2', targetDate: 'Jul 31, 2026', tag: 'Critical Program',
    jiraStatus: 'Planning',
    ...
    recentUpdate: 'AP Tool Phase 2 (OPIF-336019): In progress, 60 pts, Arun Santhiagu.  |  Multi-Select Modular Categories (OPIF-311623): Ready to Start, 150 pts, Hammad Javed.  |  Persisting Size Overrides (OPIF-304864): Ready to Start, 50 pts.  |  74 additional OPIFs in active planning and sizing.',
